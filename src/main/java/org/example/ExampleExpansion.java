...
public class ExampleExpansion extends PlaceholderExpansion {
    ...
    private boolean hasMatchingTag(Entity entity, Set<String> tags) {
        for (String tag : tags) {
...
// Check if there is an active lock
        ...
        if (identifier.startsWith("trackv3_")) {
            ...
            try {
                ...
                Set<Material> passThrough = getPassThroughMaterials();
...
// Tunable displacement to help unstick projectiles
        ...
        switch (identifier) {
            ...
            case "rayTraceBlockCoords" -> {
                return Objects.requireNonNull(Objects.requireNonNull("" + p.rayTraceBlocks(30).getHitPosition().getBlockX() + " " + p.rayTraceBlocks(30).getHitPosition().getBlockY() + " " + p.rayTraceBlocks(30).getHitPosition().getBlockZ()  ));
            }
        }

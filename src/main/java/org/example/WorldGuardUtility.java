...
public class WorldGuardUtility {
    public static @Nullable String nearestPlayerNotTeam2WORLDGUARDREQUIERD(ExampleExpansion exampleExpansion, Player f2, String f1) {
    ...
    public static @NotNull String countPlayersWORLDGUARDREQUIRED(ExampleExpansion exampleExpansion, Player f2, String f1) {

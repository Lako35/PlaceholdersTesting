...
public class ExampleExpansion2 {
    ...
    // Helper method to handle the turret logic
    public static String handleTurret(
            Plugin plugin,
            String identifier,
            Map<Location, UUID> turretLocks,
            Map<UUID, Location> lastPositions
    ) {
        ...
        try {
            ...
            new BukkitRunnable() {
                ...
                public void run() {
                    ...
                    proj.setMetadata("ArchistructureTurret", new FixedMetadataValue(plugin, damage));
